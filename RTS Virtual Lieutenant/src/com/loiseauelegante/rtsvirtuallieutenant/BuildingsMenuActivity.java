	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((Button) findViewById(R.id.academy_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  ImageView first_image = (ImageView) findViewById(R.id.imageView1);
	    	  ImageView second_image = (ImageView) findViewById(R.id.imageView2);
		...
		((Button) findViewById(R.id.armory_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.armory);
	    	  second_image.setImageResource(R.drawable.armory2);
		...
		((Button) findViewById(R.id.barracks_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.barracks);
	    	  second_image.setImageResource(R.drawable.barracks2);
		...
		((Button) findViewById(R.id.embassy_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.embassy);
	    	  second_image.setImageResource(R.drawable.embassy2);
	  		try {
		...
		((Button) findViewById(R.id.forge_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.forge);
	    	  second_image.setImageResource(R.drawable.forge2);
		...
		((Button) findViewById(R.id.great_hall_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.greathall);
	    	  second_image.setImageResource(R.drawable.greathall2);
		...
		((Button) findViewById(R.id.house_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.home);
	    	  second_image.setImageResource(R.drawable.home2);
		...
		((Button) findViewById(R.id.keep_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.keep);
	    	  second_image.setImageResource(R.drawable.keep2);
		...
		((Button) findViewById(R.id.muster_field_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.musterfield);
	    	  second_image.setImageResource(R.drawable.musterfield2);
		...
		((Button) findViewById(R.id.resource_fields_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.farm2);
	    	  second_image.setImageResource(R.drawable.arboretum);
		...
		((Button) findViewById(R.id.sage_tower_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.sagestower);
	    	  second_image.setImageResource(R.drawable.sagestower2);
		...
		((Button) findViewById(R.id.stable_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.stables);
	    	  second_image.setImageResource(R.drawable.stables2);
		...
		((Button) findViewById(R.id.tavern_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.tavern);
	    	  second_image.setImageResource(R.drawable.tavern);		//need second tavern image
		...
		((Button) findViewById(R.id.vault_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.vault);
	    	  second_image.setImageResource(R.drawable.vault2);
		...
		((Button) findViewById(R.id.wall_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  //first_image.setImageResource(R.drawable.);
	    	  //second_image.setImageResource(R.drawable.armory2);
		...
		((Button) findViewById(R.id.watch_tower_button)).setOnClickListener(new View.OnClickListener()
	    {
	      public void onClick(View paramAnonymousView)
	      {
	    	  ...
	    	  first_image.setImageResource(R.drawable.watchtower);
	    	  second_image.setImageResource(R.drawable.watchtower2);
